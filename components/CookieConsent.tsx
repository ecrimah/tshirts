...
export default function CookieConsent() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-4 border-store-navy shadow-2xl z-[9999] animate-slide-up">
        <div className="max-w-7xl mx-auto px-4 py-6">
          {!showPreferences ? (
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex items-start space-x-4 flex-1">
                <div className="w-12 h-12 flex items-center justify-center bg-store-surface rounded-lg flex-shrink-0">
                  <i className="ri-cookie-line text-2xl text-store-ink"></i>
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed mb-3">
                    ...
                    <Link href="/privacy" className="text-store-ink hover:text-store-ink font-medium ml-1 whitespace-nowrap">
                  ...
                  <label className="flex items-start space-x-2 cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 mt-0.5 text-store-ink border-gray-300 rounded focus:ring-store-primary cursor-pointer"
                    />
                    <span className="text-xs text-gray-600 group-hover:text-gray-900">
                      I agree to the{' '}
                      <Link href="/terms" className="text-store-ink hover:text-store-ink font-medium">
                        Terms & Conditions
                      </Link>
                      {' '}and{' '}
                      <Link href="/privacy" className="text-store-ink hover:text-store-ink font-medium">
                        Privacy Policy
                      </Link>
                    </span>
                  </label>
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap ${
                    acceptedTerms
                      ? 'bg-store-navy hover:bg-store-navy-light text-white cursor-pointer'
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.analytics ? 'bg-store-navy' : 'bg-gray-300'
                    }`}
                  >
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.marketing ? 'bg-store-navy' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.functional ? 'bg-store-navy' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
