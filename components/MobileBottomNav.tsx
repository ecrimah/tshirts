              ...
              return (
                <Link
                  ...
                  className={`flex flex-col items-center justify-center py-2 transition-all duration-200 relative group active:scale-90 ${
                    active ? 'text-store-ink' : 'text-gray-400'
                  }`}
                ...
                >
                  ...
                  {active && (
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-1 bg-store-navy-light rounded-full transition-all duration-300" />
                  )}
                  ...
                  <div className="relative w-7 h-7 flex items-center justify-center">
                    ...
                    {item.badge !== undefined && item.badge > 0 && (
                      <span className="absolute -top-1.5 -right-2 min-w-[18px] h-[18px] bg-store-navy-light text-white text-[10px] font-bold rounded-full flex items-center justify-center px-1 shadow-sm animate-scale-in">
