    ...
    <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-2">
          ...
          {activeFilterCount > 0 && (
            <span className="bg-store-navy text-white text-xs font-bold px-2 py-1 rounded-full">
              {activeFilterCount}
            </span>
          )}
        </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg text-sm focus:border-store-navy focus:ring-2 focus:ring-store-primary/20"
                  placeholder="Min"
                />
              ...
              <input
                ...
                value={priceRange[1]}
                onChange={(e) => handlePriceChange(1, Number(e.target.value))}
                className="w-full accent-store-navy"
              />
