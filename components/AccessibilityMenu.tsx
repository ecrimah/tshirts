  ...
  return (
    <>
      <button
        ...
        className="fixed left-0 top-1/2 -translate-y-1/2 bg-store-navy hover:bg-store-navy-light text-white p-3 rounded-r-lg shadow-lg z-[9997] transition-all"
          ...
          <div className="fixed left-0 top-0 bottom-0 w-full max-w-md bg-white shadow-2xl z-[9999] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 flex items-center justify-center bg-store-surface rounded-lg">
                  <i className="ri-accessibility-line text-xl text-store-ink"></i>
                </div>
                    ...
                    <button
                      ...
                      className={`py-2 px-4 rounded-lg border-2 font-medium transition-colors whitespace-nowrap ${
                        settings.fontSize === size
                          ? 'border-store-navy bg-store-surface text-store-ink'
              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                      settings.readableFont ? 'bg-store-navy' : 'bg-gray-300'
                    }`}
                  >
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                      settings.hideImages ? 'bg-store-navy' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                      settings.highlightLinks ? 'bg-store-navy' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
