          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-12 pr-4 py-4 border border-gray-300 rounded-full focus:ring-2 focus:ring-store-primary focus:border-store-primary text-sm shadow-lg"
              />
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-full font-medium transition-all whitespace-nowrap ${
                activeCategory === category.id
                  ? 'bg-store-navy text-white shadow-lg'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Link href="/shipping" className="bg-gray-50 p-8 rounded-2xl hover:shadow-lg transition-all cursor-pointer">
            <div className="w-12 h-12 bg-store-surface rounded-full flex items-center justify-center mb-4">
              <i className="ri-truck-line text-2xl text-store-ink"></i>
            </div>
          ...
          <Link href="/returns" className="bg-gray-50 p-8 rounded-2xl hover:shadow-lg transition-all cursor-pointer">
            <div className="w-12 h-12 bg-store-surface rounded-full flex items-center justify-center mb-4">
              <i className="ri-arrow-go-back-line text-2xl text-store-ink"></i>
            </div>
