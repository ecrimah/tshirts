    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="px-4 py-2 bg-store-navy text-white rounded-lg font-semibold hover:bg-store-navy transition-colors whitespace-nowrap"
        >
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <label className="flex items-center">
                <input type="checkbox" className="w-4 h-4 text-store-primary border-gray-300 rounded focus:ring-store-primary" />
            ...
            <div className="md:col-span-2 flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
              <button
                type="submit"
                className="flex-1 py-3 bg-store-navy text-white rounded-lg font-semibold hover:bg-store-navy transition-colors whitespace-nowrap"
              >
                Save Address
              </button>
              <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {addresses.map((address) => (
          <div
            key={address.id}
            className={`bg-white border-2 rounded-lg p-6 relative ${address.isDefault ? 'border-store-navy' : 'border-gray-200'
              }`}
          >
            {address.isDefault && (
              <div className="absolute top-4 right-4">
                <span className="px-3 py-1 bg-store-navy text-white text-xs font-semibold rounded-full whitespace-nowrap">
                  Default
                </span>
              </div>
            )}
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
              ...
              {!address.isDefault && (
                <button
                  ...
                  className="flex-1 py-2 border border-store-navy text-store-primary rounded-lg font-semibold hover:bg-store-surface transition-colors whitespace-nowrap"
                >
                  Set Default
                </button>
              )}
