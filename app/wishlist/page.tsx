...
export default function WishlistPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <PageHero title="My Wishlist" backgroundImage="/hero_wishlist_1772075051697.png" />
          ...
          <div className="flex items-center justify-between">
            <div>
              <nav className="flex items-center space-x-2 text-sm mb-2">
                <Link href="/" className="text-gray-600 hover:text-store-ink transition-colors">Home</Link>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="bg-gradient-to-r from-store-navy to-store-navy-light rounded-2xl p-12 text-center text-white">
            <h2 className="text-3xl font-bold mb-4">Share Your Wishlist</h2>
            <p className="text-white/90 mb-8 text-lg">Let friends and family know what you love</p>
