          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-6">
            <div className="mb-6 pb-6 border-b border-gray-200">
              <div className="flex items-center space-x-3 mb-4">
                <span className="px-3 py-1 bg-store-primary/15 text-store-primary rounded-full text-sm font-semibold whitespace-nowrap">
                  {article.category}
                </span>
            ...
            {!showFeedback ? (
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 py-3 px-6 border-2 border-store-navy text-store-primary hover:bg-store-navy hover:text-white rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                ...
                {wasHelpful ? (
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-store-primary/15 rounded-full mx-auto mb-4">
                      <i className="ri-check-line text-3xl text-store-primary"></i>
                    </div>
                  ...
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-store-primary/15 rounded-full mx-auto mb-4">
                      <i className="ri-customer-service-line text-3xl text-store-primary"></i>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 mb-2">
              ...
              {relatedArticles.map((related) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <i className="ri-file-text-line text-xl text-store-primary"></i>
                    <div>
