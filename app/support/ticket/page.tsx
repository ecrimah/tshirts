        ...
        <main className="min-h-screen bg-gray-50 flex items-center justify-center py-12">
          <div className="max-w-md mx-auto px-4 text-center">
            <div className="bg-white rounded-xl shadow-lg p-8">
              <div className="w-20 h-20 flex items-center justify-center bg-store-primary/15 rounded-full mx-auto mb-6">
                <i className="ri-check-line text-4xl text-store-primary"></i>
              </div>
              ...
              <div className="space-y-3">
                ...
                <Link
                  ...
                  className="block bg-store-navy hover:bg-store-navy text-white py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                  View My Tickets
                </Link>
                <Link
                  href="/help"
                  className="block text-store-primary hover:text-store-ink font-semibold whitespace-nowrap"
                >
                  Back to Help Center
                </Link>
              </div>
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <Link
            href="/help"
            className="inline-flex items-center text-store-primary hover:text-store-ink font-semibold mb-6 whitespace-nowrap"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <i className={`${cat.icon} text-2xl ${
                          formData.category === cat.value ? 'text-store-primary' : 'text-gray-400'
                        }`}></i>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <label className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                    formData.priority === 'normal' ? 'border-store-navy bg-store-surface' : 'border-gray-300'
                  }`}>
                    <input
                      type="radio"
                      value="normal"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-store-primary focus:border-store-primary h-32 resize-none"
              ...
              <div className="flex space-x-4 pt-6">
                ...
                <button
                  ...
                  className="flex-1 py-4 bg-store-navy hover:bg-store-navy text-white rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                >
                  {isSubmitting ? (
                    <>
          ...
          <div className="mt-8 bg-store-surface border border-store-primary/30 rounded-xl p-6">
            <div className="flex items-start space-x-3">
              <i className="ri-information-line text-2xl text-store-primary mt-0.5"></i>
              <div>
                <p className="font-semibold text-store-ink mb-2">Before submitting a ticket</p>
                <ul className="text-sm text-store-primary space-y-1">
                  <li>• Check our <Link href="/help" className="underline hover:text-store-ink">Help Center</Link> for quick answers</li>
