        ...
        <div className="max-w-4xl mx-auto px-4">
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center flex-1">
                  <div className={`w-10 h-10 flex items-center justify-center rounded-full font-bold ${
                    i <= step ? 'bg-store-navy text-white' : 'bg-gray-200 text-gray-500'
                  }`}>
                    {i < step ? <i className="ri-check-line"></i> : i}
                  </div>
                  {i < 3 && (
                    <div className={`flex-1 h-1 mx-4 ${
                      i < step ? 'bg-store-navy' : 'bg-gray-200'
                    }`}></div>
                  )}
                </div>
              ))}
            ...
            <div className="bg-white rounded-xl shadow-sm p-8">
              ...
              <form onSubmit={handleFindOrder} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-store-navy hover:bg-store-navy text-white py-4 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                >
                  {isLoading ? 'Finding Order...' : 'Find Order'}
                </button>
              </form>

              <div className="mt-8 p-4 bg-store-surface border border-store-primary/30 rounded-lg">
                <div className="flex items-start space-x-3">
                  <i className="ri-information-line text-xl text-store-primary mt-0.5"></i>
                  <div className="text-sm text-store-primary">
            ...
            <div className="bg-white rounded-xl shadow-sm p-8">
                  ...
                  <div key={item.id} className="border-2 border-gray-200 rounded-lg p-4">
                    <div className="flex items-start space-x-4">
                      <input
                        ...
                        className="mt-1 w-5 h-5 text-store-primary rounded border-gray-300 focus:ring-store-primary"
                      />
                        ...
                        {selectedItems.includes(item.id) && (
                          <div className="mt-4">
                            ...
                            <select
                              ...
                              className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-store-primary focus:border-store-primary pr-8"
                              required
                            >
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <i className="ri-refund-line text-2xl text-store-primary mb-2"></i>
                  ...
                  >
                    <i className="ri-exchange-line text-2xl text-store-primary mb-2"></i>
          ...
          {step === 3 && (
            <div className="bg-white rounded-xl shadow-sm p-8">
              ...
              <div className="mb-8 p-6 border-2 border-store-primary/30 bg-store-surface rounded-lg">
